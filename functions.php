...
function press_post_type() {
	...
	$labels = array(
		'name'                => _x( 'Press Posts', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'Press Post', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Press', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Item:', 'text_domain' ),
		'all_items'           => __( 'All Items', 'text_domain' ),
		'view_item'           => __( 'View Post', 'text_domain' ),
		'add_new_item'        => __( 'Add New Press Post', 'text_domain' ),
		'add_new'             => __( 'Add New', 'text_domain' ),
		'edit_item'           => __( 'Edit Post', 'text_domain' ),
		'update_item'         => __( 'Update Post', 'text_domain' ),
...
register_taxonomy( 'taxonomy', array( 'projects' ), $args );
...
// remove p tags from images in blog posts

function filter_ptags_on_images($content){
   return preg_replace('/<p class="p1">\s*(<a .*>)?\s*(<img .* \/>)\s*(<\/a>)?\s*<\/p>/iU', '\1\2\3', $content);
}
